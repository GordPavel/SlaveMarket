...
public class CommandLineView implements View {
    ...
    private void startMenu(Scanner scanner) {
        ...
        Pattern search = Pattern.compile("^(\\bSEARCH\\b)[ ]+([\\w ]*)", Pattern.CASE_INSENSITIVE);
        ...
        Pattern dataExport = Pattern.compile("export ([.a-zA-Z0-9\\/-]+)", Pattern.CASE_INSENSITIVE);
        Pattern dataImport = Pattern.compile("import ([.a-zA-Z0-9\\/-]+)", Pattern.CASE_INSENSITIVE);
        Matcher exitMatcher;
